...
namespace Bonyan.Controllers
{
    public class ProductGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,TitleEn,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] ProductGroup productGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,TitleEn,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] ProductGroup productGroup)
        {
            if (ModelState.IsValid)
            {
				productGroup.IsDeleted=false;
